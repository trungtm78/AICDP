...
const SOURCES: CatalogConnector[] = [
  ...
  // Nguồn VN (webhook native + payloadMapping cấu hình field-path -> shape CDP).
  { key: "src_kiotviet", name: "KiotViet (POS/Retail)", direction: "source", category: "Kênh Việt Nam", transport: "webhook", vn: true, blurb: "Nhận hoá đơn/đơn hàng KiotViet (map field cấu hình).", configFields: [{ key: "brand_id", label: "Brand", type: "text" }] },
  { key: "src_ghn", name: "GHN (Giao Hàng Nhanh)", direction: "source", category: "Kênh Việt Nam", transport: "webhook", vn: true, blurb: "Nhận cập nhật trạng thái/đơn GHN (map field cấu hình).", configFields: [{ key: "brand_id", label: "Brand", type: "text" }] },
  { key: "src_misa", name: "MISA (Kế toán/CRM)", direction: "source", category: "Kênh Việt Nam", transport: "webhook", vn: true, blurb: "Nhận khách hàng/giao dịch MISA (map field cấu hình).", configFields: [{ key: "brand_id", label: "Brand", type: "text" }] },
  ...
  // ERP generic REST/OData INBOUND-pull (payloadMapping cấu hình) + preset SAP/Oracle.
  { key: "src_rest", name: "REST / OData (Generic)", direction: "source", category: "ERP / Hệ thống", transport: "rest", blurb: "Kéo bản ghi từ API REST/OData bất kỳ (map field cấu hình).", configFields: [{ key: "endpoint", label: "Endpoint URL", type: "url" }, apiKeyField, { key: "brand_id", label: "Brand", type: "text" }] },
  { key: "src_sap", name: "SAP (OData)", direction: "source", category: "ERP / Hệ thống", transport: "rest", blurb: "Kéo dữ liệu SAP qua OData service.", configFields: [{ key: "endpoint", label: "OData endpoint", type: "url" }, apiKeyField, { key: "brand_id", label: "Brand", type: "text" }] },
  { key: "src_oracle", name: "Oracle (REST/OData)", direction: "source", category: "ERP / Hệ thống", transport: "rest", blurb: "Kéo dữ liệu Oracle qua REST/OData.", configFields: [{ key: "endpoint", label: "Endpoint", type: "url" }, apiKeyField, { key: "brand_id", label: "Brand", type: "text" }] },
...
const DESTINATIONS: CatalogConnector[] = [
  ...
  { key: "dst_vietguys", name: "VietGuys (SMS Brandname)", direction: "destination", category: "Kênh Việt Nam", transport: "rest", vn: true, blurb: "SMS brandname trong nước.", configFields: [{ key: "user", label: "Username", type: "text" }, { key: "apiKey", label: "Password", type: "password", secret: true }, { key: "brandname", label: "Brandname", type: "text" }] },
  { key: "dst_esms", name: "eSMS.vn (SMS/Zalo)", direction: "destination", category: "Kênh Việt Nam", transport: "rest", vn: true, blurb: "SMS brandname + Zalo qua eSMS.vn.", configFields: [{ key: "apiKey", label: "API key", type: "password", secret: true }, { key: "secretKey", label: "Secret key", type: "password", secret: true }, { key: "brandname", label: "Brandname", type: "text" }] },
